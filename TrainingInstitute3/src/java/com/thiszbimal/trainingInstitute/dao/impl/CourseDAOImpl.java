 ...
 */
package com.thiszbimal.trainingInstitute.dao.impl;

import com.thiszbimal.trainingInstitute.constant.SQLConstant;
import com.thiszbimal.trainingInstitute.dao.CourseDAO;
import com.thiszbimal.trainingInstitute.dbutil.DbConnection;
...
public class CourseDAOImpl implements CourseDAO{
    ...
    public int delete(int id) throws SQLException, ClassNotFoundException {
        conn.open();
        PreparedStatement stmt = conn.init(SQLConstant.COURSE_DELETE);
        int result = conn.executeUpdate();
        conn.close();
        return result;
    }
